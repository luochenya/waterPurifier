<template>
  <div class="filter-content">
          ...
          <div v-if="toViewDetails">
            ...
            <div class="content">
              <div
                class="pic"
                :class="{
                  pic_2: isRemainLife === 50 && toViewDetails.RemainDays >= 30,
                  pic_3: isRemainLife < 50 && toViewDetails.RemainDays < 30
                }"
              >
                <p>
                  {{
                    toViewDetails.RemainLife === "無最後更換紀錄"
                      ? "100%"
                      : toViewDetails.RemainLife
                  }}
                </p>
                <span>濾心壽命</span>
              </div>
        ...
        <el-card class="list-box">
          ...
          <div class="list">
            <vue-scroll :ops="ops">
              ...
              <span class="hint" v-if="orderHistory === undefined"
                >暫無更換記錄</span
              >
              <el-row v-else v-for="(item, index) in orderHistory" :key="index">
                ...
                <el-col :xs="14" :sm="14" :md="7" :lg="9">
                  <span v-if="item.Mfno === '此道濾心尚無製造號碼'"
                    >製號: 無</span
                  >
          ...
          <div class="btn">
            <div class="item item_1" @click="goBuy">專人保養服務</div>
            <div class="item item_2" @click="btnClick">自行保養更換</div>
          </div>
        </el-card>
      </el-col>
    </el-row>
    <guide-four
      :isDialogShow="isShowGuideFour"
    ...
    <guide-four
      :isDialogShow="isShowVarning"
      :confirmClick="varningConfirmClick"
      :noClick="varningNoClick"
      :varning="true"
    ></guide-four>
  ...
  .el-col:first-of-type {
    .content {
      ...
      .pic {
        ...
        box-shadow: 0 12px 30px 0 rgba(1, 181, 240, 0.15);
        color: #fff;
        p {
          line-height: 3.7rem;
          font-size: 2.6rem;
      ...
      .pic_2 {
        ...
        background-size: 100% auto;
        box-shadow: 0 12px 30px 0 rgba(255, 141, 45, 0.15);
      }
      .pic_3 {
        background: url("../assets/img/Fill 1red@2x (2).png") no-repeat;
        background-size: 100% auto;
        box-shadow: 0 12px 30px 0 rgba(254, 96, 59, 0.15);
      }
      .bottom {
        display: flex;
        flex-direction: column;
